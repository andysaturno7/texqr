...
MainViewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MainViewComponent, selectors: [["conf-main-view"]], decls: 5, vars: 1, consts: [[1, "input-group", 2, "max-width", "300px"], [1, "input-group-prepend"], [1, "input-group-text"], ["type", "text", "readonly", "", 1, "form-control", 3, "placeholder"]], template: function MainViewComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("placeholder", ctx.ip ? ctx.ip : "No est\u00E1 conectado ninguna red");
